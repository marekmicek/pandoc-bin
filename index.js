...
var bin = new BinWrapper({ global: false })
	.src('https://github.com/marekmicek/pandoc-bin/raw/master/vendor/osx/pandoc', 'darwin')
	.src('https://github.com/marekmicek/pandoc-bin/raw/master/vendor/linux/pandoc', 'linux')
	.src('https://github.com/marekmicek/pandoc-bin/raw/master/vendor/win/pandoc.exe', 'win32')
